...
# Особенности использования сервисов Amnezia на iOS в России

## Общая информация[​](amnezia-on-ios-in-russia.html#общая-информация "Прямая
ссылка на Общая информация")

В **российском** App Store не получится скачать последнюю приложения
AmneziaVPN, поэтому мы подготовили [инструкцию](installing-amneziavpn-on-
ios.html), которая поможет вам установить AmneziaVPN на iOS через смену
региона аккаунта в App Store или через создание нового аккаунта Apple в другом
регионе.

Если на вашем iOS-устройстве установлено устаревшее приложение AmneziaVPN, вы
можете **обновить** его до последней версии **без смены региона**. Для этого
зайдите в системные настройки iOS-устройства → "Основные" → "Хранилище iPhone"
→ выберите "AmneziaVPN" → нажмите "Сгрузить приложение" → "Переустановить".

Также на устройствах **iOS** вы можете использовать [**DefaultVPN**](amnezia-
on-ios-in-
russia.html#%D0%BF%D1%80%D0%B8%D0%BB%D0%BE%D0%B6%D0%B5%D0%BD%D0%B8%D0%B5-defaultvpn)
— это наше альтернативное приложение, **доступное в российском App Store**.

* * *

# Варианты использования приложений AmneziaVPN и DefaultVPN

## Amnezia Free[​](amnezia-on-ios-in-russia.html#amnezia-free "Прямая ссылка
на Amnezia Free")

### Вариант 1: Создание подключения в приложении AmneziaVPN[​](amnezia-on-ios-
in-russia.html#вариант-1-создание-подключения-в-приложении-amneziavpn "Прямая
ссылка на Вариант 1: Создание подключения в приложении AmneziaVPN")

Убедитесь, что вы **не подключены к VPN** и открываете приложение AmneziaVPN
**с территории России**.

  1. Откройте приложение **AmneziaVPN**.
  2. Нажмите на кнопку **Приступим** или на иконку ➕ (**плюс**), если у вас уже есть другие подключения.
  3. Выберите вариант подключения **VPN от Amnezia** и дождитесь загрузки.
  4. Нажмите на **Amnezia Free RU** → **Подключиться**.

Cоздалось новое подключение **Amnezia Free** — можно подключаться.

![](../../assets/images/ru_AV_FREE_voa-3fa1812d9329bb942152acdfc51bbf01.png)

* * *

### Вариант 2: Подключение через ключ в приложениях AmneziaVPN и
DefaultVPN

Для получения
[ключа](https://storage.googleapis.com/amnezia/amnezia.org?m-path=/ru/free)
откройте нашего бота в Telegram:

  1. Нажмите кнопку **Start** в чате с ботом, в ответ вы получите сообщение с ключом **vpn://** для подключения.
  2. Нажмите на ключ — так он скопируется в буфер обмена.
  3. Откройте приложение **AmneziaVPN** или **DefaultVPN** и нажмите на иконку ➕ (**плюс**) или на кнопку **Приступим** в приложении **AmneziaVPN** , если у вас не было других подключений.
  4. Нажмите кнопку **Вставить** возле поля для ввода ключа → **Продолжить** /**Добавить** → **Подключиться**.

Создалось новое подключение **Amnezia Free** — можно подключаться.

![](../../assets/images/TG_key-d1d4c90655fccd384e7e5842e2021e0a.png)

![](../../assets/images/ru_AV_key-f59b962b7903df8e18b10683e5ee922c.png)

![](../../assets/images/ru_DV_create_FREE-15d393c7323b9ba6a583faaa0d315c0c.png)

* * *

### FAQ при подключении Amnezia Free
...
Прежде всего попробуйте сбросить конфигурации API:
  ...
  1. На главном экране приложения **AmneziaVPN** или **DefaultVPN** нажмите на значок «▾» (**стрелочка** справа от подключения **Amnezia Free** , с которым возникла проблема).
  2. В следующем окне нажмите на кнопку **Сбросить конфигурацию API** , затем **Продолжить**.
...
### Подключение через ключ в приложениях AmneziaVPN и DefaultVPN
...
### FAQ при подключении Amnezia Premium
...
### Управление подпиской (личный кабинет)
...
## Меню настроек приложения AmneziaVPN
